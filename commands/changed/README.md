...
Unlike `lerna ls`, however, `lerna changed` **does not** support [filter options](https://www.npmjs.com/package/@0x-lerna-fork/filter-options), as filtering is not supported by `lerna version` or `lerna publish`.
