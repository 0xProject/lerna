...
describe("npm-publish", () => {
  ...
  runLifecycle.mockName("@0x-lerna-fork/run-lifecycle").mockResolvedValue();
  otplease.mockName("@0x-lerna-fork/otplease").mockImplementation((cb, opts) => Promise.resolve(cb(opts)));
