...
- `command.publish.message`: a custom commit message when performing version updates for publication. See [@0x-lerna-fork/version](commands/version#--message-msg) for more details. 
